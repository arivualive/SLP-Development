...
var app = {
  initdropdown: function () {
    // -----------------------------------------------------
    // --------- beginning of custom select widget ---------
    // -----------------------------------------------------
    ...
    //fonctionnalités utilisées classées de la plus risquée à la plus sure:
    //1 classList
    //2 addEventListener
    ...
    //  l'objet retourné par la fonction querySelectorAll() est une NodeList plutôt qu'un Array
    // ajout de la prise en charge de forEach à NodeList
    ...
    // optList est une classe du ul de la liste déroulante js
    var optList = select.querySelector('.optList');

    // Nous cachons la liste des options
    // ajout de la classe hidden en plus des classes existantes dans le ul de optList
    optList.classList.add('hidden');

    // et nous désactivons le widget personnalisé lui-même
    // suppression de la classe active dans le ul de optList
    ...
    if (select.classList.contains('active')) return; // pour sortir de la fonction
    ...
    function updateValue(select, index) {
      ...
      // Nous devons aussi obtenir la valeur de remplacement du widget personnalisé
    ...
    // link = https://developer.mozilla.org/fr/docs/Web/Guide/HTML/Formulaires/Comment_construire_des_widgets_de_formulaires_personnalis%C3%A9s
    // -----------------------------------------------------
    // ------------ end of custom select widget ------------
    // -----------------------------------------------------
  } 
}
$(app.initdropdown);
